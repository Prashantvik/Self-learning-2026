...
# Getters and Setter implementation using property decorator
class Employee:
    ...
    # Implementing a setter with the same name
    @fullname.setter
    ...
    # Implementing a deleter with the same name
    @fullname.deleter
    def fullname(self):
        print("Deleting name!")
